...
import com.sky.magicBox.shiro.config.RestPathMatchingFilterChainResolver;
import com.sky.magicBox.shiro.provider.ShiroFilterRulesProvider;
import com.sky.magicBox.shiro.rule.RolePermRule;
import com.sky.magicBox.support.SpringContextHolder;
...
public class ShiroFilterChainManager {
    ...
    public Map<String,String> initGetFilterChain() {
        ...
        // -------------anon 默认过滤器忽略的URL
        List<String> defalutAnon = Arrays.asList("/css/**","/js/**","/appMini/**");
